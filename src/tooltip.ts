...
export interface ExtendedTooltip extends TooltipModel<'boxplot'> {
  _tooltipOutlier?: {
    index: number;
    datasetIndex: number;
  };
...
export function patchInHoveredOutlier(this: TooltipModel<'boxplot'>, item: TooltipItem<'boxplot'>): void {
